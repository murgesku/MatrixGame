...
#define DMDEFINES
// hack!
__inline void DM(const char *s1, const char *s2) {
    DM((char *)s1, (char *)s2);
};
__inline void DM_(const char *s1, const char *s2) {
    DM_((char *)s1, (char *)s2);
}
__inline void DM(const wchar_t *s1, const wchar_t *s2) {
    DM((wchar_t *)s1, (wchar_t *)s2);
}
__inline void DM_(const wchar_t *s1, const wchar_t *s2) {
