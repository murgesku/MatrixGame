...
class CMatrixGroupObject : public CMain
{
    ...
    public:
        ...
        CMatrixGroupObject()                                            { m_Object=NULL; m_NextObject=NULL; m_PrevObject=NULL; m_ParentGroup=NULL; m_Team=-1; }
        ~CMatrixGroupObject();
};
...
//        void LogicTakt(CMatrixSideUnit* side);
//
//        CMatrixGroupList()                                                  { m_GroupsCnt=0; m_FirstGroup=NULL; m_LastGroup=NULL; m_ReGroupPeriod=0; }
//        ~CMatrixGroupList();
//};
