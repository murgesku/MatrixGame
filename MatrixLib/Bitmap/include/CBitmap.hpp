...
class /* BITMAP_API */ CBitmap : public Base::CMain {
	...
	public:
		...
		void Create16(int lenx,int leny)						{ Clear(); m_Size.x=lenx; m_Size.y=leny; m_Pitch=lenx*2; m_Format=BMF_FLAT; m_BytePP=2; m_BitPP=16; m_MColor[0]=0x0000f800; m_MColor[1]=0x000007e0; m_MColor[2]=0x0000001f; AllocData(); }
		void Create15(int lenx,int leny)						{ Clear(); m_Size.x=lenx; m_Size.y=leny; m_Pitch=lenx*2; m_Format=BMF_FLAT; m_BytePP=2; m_BitPP=15; m_MColor[0]=0x00007c00; m_MColor[1]=0x000003e0; m_MColor[2]=0x0000001f; AllocData(); }
		void CreateRGB(int lenx,int leny)						{ Clear(); m_Size.x=lenx; m_Size.y=leny; m_Pitch=lenx*3; m_Format=BMF_FLAT; m_BytePP=3; m_BitPP=24; m_MColor[0]=0x000000ff; m_MColor[1]=0x0000ff00; m_MColor[2]=0x00ff0000; AllocData(); }
		void CreateRGB(int lenx,int leny,int pitch)				{ Clear(); m_Size.x=lenx; m_Size.y=leny; m_Pitch=max(lenx*3,pitch); m_Format=BMF_FLAT; m_BytePP=3; m_BitPP=24; m_MColor[0]=0x000000ff; m_MColor[1]=0x0000ff00; m_MColor[2]=0x00ff0000; AllocData(); }
		void CreateRGBA(int lenx,int leny)						{ Clear(); m_Size.x=lenx; m_Size.y=leny; m_Pitch=lenx*4; m_Format=BMF_FLAT; m_BytePP=4; m_BitPP=32; m_MColor[0]=0x000000ff; m_MColor[1]=0x0000ff00; m_MColor[2]=0x00ff0000; m_MColor[3]=0xff000000; AllocData(); }
		void CreateRGBA(int lenx,int leny,int pitch)			{ Clear(); m_Size.x=lenx; m_Size.y=leny; m_Pitch=max(lenx*4,pitch); m_Format=BMF_FLAT; m_BytePP=4; m_BitPP=32; m_MColor[0]=0x000000ff; m_MColor[1]=0x0000ff00; m_MColor[2]=0x00ff0000; m_MColor[3]=0xff000000; AllocData(); }
		void CreateRGBA(int lenx,int leny,int pitch,void *data)	{ Clear(); m_Size.x=lenx; m_Size.y=leny; m_Pitch=pitch; m_Format=BMF_FLAT; m_BytePP=4; m_BitPP=32; m_MColor[0]=0x000000ff; m_MColor[1]=0x0000ff00; m_MColor[2]=0x00ff0000; m_MColor[3]=0xff000000; m_Data=data; m_DataExt=true; }
        void SetRGBA(int lenx,int leny)	{ m_Size.x=lenx; m_Size.y=leny; m_Pitch=lenx*4; m_Format=BMF_FLAT; m_BytePP=4; m_BitPP=32; m_MColor[0]=0x000000ff; m_MColor[1]=0x0000ff00; m_MColor[2]=0x00ff0000; m_MColor[3]=0xff000000; }
        ...
        void Tile(const Base::CPoint & pdes,const Base::CPoint & desize, const CBitmap & bmsou,const Base::CPoint & spsou, const Base::CPoint & szsou);
		...
		void Rotate90(const Base::CPoint & pdes,const Base::CPoint & sizesou,const CBitmap & bmsou,const Base::CPoint & spsou);
		void Rotate180(const Base::CPoint & pdes,const Base::CPoint & sizesou,const CBitmap & bmsou,const Base::CPoint & spsou);
		void Rotate270(const Base::CPoint & pdes,const Base::CPoint & sizesou,const CBitmap & bmsou,const Base::CPoint & spsou);
		...
		void MergeByMask(	const Base::CPoint & pdes,const Base::CPoint & size,
		...
		void MergeWithAlpha(const Base::CPoint & pdes,const Base::CPoint & size, const CBitmap & bmsou,const Base::CPoint & spsou);
		void MergeWithAlphaPM(const Base::CPoint & pdes,const Base::CPoint & size, const CBitmap & bmsou,const Base::CPoint & spsou); // PM - premultiplied alpha

        void MergeGrayscaleWithAlpha(const Base::CPoint & pdes,const Base::CPoint & size, const CBitmap * data_src,const Base::CPoint & data_src_point, const CBitmap * alpha_src, const Base::CPoint & alpha_src_point);
        void MergeGrayscaleWithAlphaPM(const Base::CPoint & pdes,const Base::CPoint & size, const CBitmap * data_src,const Base::CPoint & data_src_point, const CBitmap * alpha_src, const Base::CPoint & alpha_src_point);
        void ModulateGrayscaleWithAlpha(const Base::CPoint & pdes,const Base::CPoint & size, const CBitmap * alpha_src, const Base::CPoint & alpha_src_point);

		dword UserData(void)			{ return m_UserData; }
		void UserData(dword zn)			{ m_UserData=zn;; }
		...
		void SaveInDDSUncompressed(const wchar * filename)	const					{ SaveInDDSUncompressed(filename,Base::WStrLen(filename)); }
