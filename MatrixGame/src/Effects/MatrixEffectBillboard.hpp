...
protected:
    ...
    CMatrixEffectBillboard(const D3DXVECTOR3 &pos, float radius1,float radius2, DWORD c1, DWORD c2, float ttl, float delay, const wchar *tex, const D3DXVECTOR3 &dir, ADD_TAKT addtakt = NULL);
...
protected:
    ...
    CMatrixEffectBillboardLine(const D3DXVECTOR3 &pos0, const D3DXVECTOR3 &pos1,float width, DWORD c1, DWORD c2, float ttl, CTextureManaged *tex);
