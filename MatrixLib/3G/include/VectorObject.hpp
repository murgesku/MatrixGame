...
public:
    ...
    SVOGeometrySimple * GetGS(void) {return m_GeometrySimple;}
        ...
        static CTextureManaged* CalcShadowTexture(int cnt, CVectorObjectAnim ** obj, const int * noframe, const D3DXMATRIX * wm, const SProjData & pd,int texsize, CVOShadowCliper *cliper, CBaseTexture * tex_to_update = NULL);
        static CTextureManaged* CalcShadowTextureWOMat(int cnt, CVectorObjectAnim ** obj, const int * noframe, const D3DXMATRIX * wm,int texsize,CVOShadowCliper *cliper, CBaseTexture * tex_to_update = NULL);
        ...
        bool    IsNoSkin(int surf)
        {
            return m_Geometry.m_Surfaces[surf].skin == NULL;
        }
