...
void CMatrixConfig::SetDefaults(void)
{
    ...
    m_KeyActions[KA_GATHERING_POINT] = 0x47; //”становка точки сбора базы, клавиша G, sub
    m_KeyActions[KA_BUILD_ROBOT] = 0x42;  //ќткрывает и закрывает меню строительства робота, sub
       //“олько из меню строительства
    ...
    m_KeyActions[KA_BUILD_TURRET] = 0x54; //ќткрывает и закрывает меню выбора турели, sub
