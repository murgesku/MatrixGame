...
void CMatrixEffectShleif::AddSmoke(const D3DXVECTOR3 &pos, float ttl, float puffttl, float spawntime, DWORD color, bool intense, float speed)
{
...
void CMatrixEffectShleif::AddFire(const D3DXVECTOR3 &pos, float ttl, float puffttl, float spawntime, float dispfactor, bool intense, float speed)
{
    if (m_SmokesCnt < SHLEIF_MAX_SMOKES)
    {
