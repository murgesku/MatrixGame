...
void CMatrixMapLogic::DumpLogic() {
    ...
    char *ats[] = {"mlat_None",    "mlat_Defence", "mlat_Attack",   "mlat_Forward",
                   "mlat_Retreat", "mlat_Capture", "mlat_Intercept"};
    char *rss[] = {"ROBOT_IN_SPAWN", "ROBOT_BASE_MOVEOUT", "ROBOT_SUCCESSFULLY_BUILD", "ROBOT_CARRYING",
                   "ROBOT_FALLING",  "ROBOT_DIP",          "ROBOT_BASE_CAPTURE",       "ROBOT_EMBRYO"};
    char *ros[] = {"ROBOT_EMPTY_ORDER", "ROT_MOVE_TO",   "ROT_MOVE_BACK",       "ROT_MOVE_RETURN", "ROT_STOP_MOVE",
                   "ROT_FIRE",          "ROT_STOP_FIRE", "ROT_CAPTURE_FACTORY", "ROT_STOP_CAPTURE"};
    char *rps[] = {"ROBOT_EMPTY_PHASE",  "ROBOT_WAITING_FOR_PARAMS", "ROBOT_MOVING",           "ROBOT_FIRING",
