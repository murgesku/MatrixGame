...
#define MAXVER_INTERNALNAME "egexp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "egexp.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "EG file exporter (plugin)\0"//should  be overidden on a per-dll level
